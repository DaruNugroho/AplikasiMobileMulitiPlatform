...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private userProvider: UserProvider, private platform: Platform, private toastController: ToastController) {
