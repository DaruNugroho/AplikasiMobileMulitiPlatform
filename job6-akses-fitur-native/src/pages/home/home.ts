...
export class HomePage {
  ...
  // fungsi yang menampilkan data pada kategori
  showCategory() {
  ...
  // fungsi ketika category diklik dapat melakukan aksi tertentu
  ...
  showPublicProduct() {
    ...
    // fungsi untuk menampilkan produk yang lebih banyak ketika di scroll kebawah 
    ...
    // fungsi yang dipanggil saat halaman discroll
    ...
    //fungsi untuk membuka halaman DetailProduct
